...
<center><img src="images/HCE8.png" width="150" height="150">
<img src="images/apj sir.png" align="right"  width="150" height="150"></center>
    <a href="hceOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
{
	response.sendRedirect("errorHceOneView.html");
}
}
catch(Exception e)
{
	out.println("Enter Valid Roll Number");
}
%>