...
<title>HCE</title>
<body>
<div style="background-color:#cc3300;">
<img src="images/logo.png"  align="left"width="100" height="100">
<center><img src="images/HCE8.png" width="100" height="100">
...
<body style="background-image: url('images/Hall5.jpg');">
<main class="my-form">
    <div class="cotainer">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" default value="B.Tech" class="form-control" name="course" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="branch" title="Please select a branch" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" min="10001" max="19999" class="form-control" name="rollNo" required>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" min="0" max="100" class="form-control" name="s1" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" min="0" max="50" class="form-control" name="s6" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" min="0" max="50" class="form-control" name="s7" required>
                                    </div>
                                </div>
                                
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" onsubmit="return marks()">
                                       Save
                                        </button>
                                    </div>
                                </div>
